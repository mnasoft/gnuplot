...
#+RESULTS:
: #GRAPH(VC=12 RC=3)
: (T:"out-plot" T:"make-plot" T:"make-func-polynom-fit" T:"*point-type-fill-box*" T:"*point-type-open*" T:"*point-type-all*" T:"*point-type-fill*" T:"*color-names*" T:"*point-type-box-fill*" T:"*point-type-box*" T:"*color-names-list*" T:"*const-names*" )
